...
from mmdet3d.datasets import DATASETS, S3DISDataset
from .show_result import show_result


@DATASETS.register_module()
class MyS3DISDataset(S3DISDataset):
    def show(self, results, out_dir, show=True, pipeline=None):
        ...
        for i, result in enumerate(results):
            ...
            print(gt_bboxes.shape, gt_labels.shape, pred_bboxes.shape, pred_labels.shape)
