...
def convert_float_sp(sp):
    return ME.SparseTensor(sp.F.float(), coordinate_map_key=sp.coordinate_map_key, coordinate_manager=sp.coordinate_manager)
